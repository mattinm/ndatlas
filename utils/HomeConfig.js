module.exports = {
    ...
    'groups': [
        ...
        {
            'name': 'Population change in North Dakota',
            ...
            'members': [
                ...
                'Students from A&S499: MacIan Campbell',
                'Students from GEOG471: Dylan Babiracki, Luke Belanus, Robert Schneider'
            ]
        },
        {
            'name': 'Boundary changes of Native American Lands in North Dakota',
        ...
        {
            'name': 'Religious affiliation change in North Dakota',
        ...
        {
            'name': 'Web design of the interactive atlas',
            'description': 'We\'re challenged with creating the interactive, online application for the North Dakota Atlas project. Our primary goals are: (1) to create a clean, intuitive interface for the students gathering the information, maps, and narratives to easily create and maintain the atlas without needing further technical assistance; and (2) allow for the creation of interactive maps from digital data on-the-fly, allowing for the dynamic creation for maps from available data for integration with narratives.<br><br>Our biggest challenges will be developing a user interface that is consistent for multiple devices and screen sizes, including phones, tablets, laptops, and desktops and integrating existing technologies and algorithms to allow for the dynamic elements of the atlas.<br><br>By creating a content management system, our application can be extended to further projects and allow other schools or organizations to create their own online atlas. We look forward to helping honor North Dakota\'s 125th anniversary and helping with a project that has great educational and informational potential.',
            'members': [
        ...
        {
            'name': 'Artistic design of the interactive atlas',
            'description': 'Brittney is working closely with all the other students on creating the design for the map templates and for the online interactive atlas.',
            'members': [
